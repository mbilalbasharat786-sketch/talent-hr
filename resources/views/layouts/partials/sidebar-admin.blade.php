...
<a class="nav-link" href="/admin/dashboard"><i class="bi bi-speedometer2"></i><span>Dashboard</span></a>
<a class="nav-link" href="/admin/reports"><i class="bi bi-graph-up"></i><span>Reports</span></a>
<div class="nav-section">Verifications</div>
...
<div class="nav-section">Risk & Audit</div>
<a class="nav-link" href="/admin/fraud-logs"><i class="bi bi-shield-exclamation"></i><span>Fraud Logs</span></a>
<a class="nav-link" href="/admin/activity-logs"><i class="bi bi-clock-history"></i><span>Activity Logs</span></a>
