...
<a class="nav-link" href="/candidate/dashboard"><i class="bi bi-speedometer2"></i><span>Dashboard</span></a>
<a class="nav-link" href="/candidate/profile"><i class="bi bi-person-circle"></i><span>Profile</span></a>
